...
import { loginAdmin, clearErrors, refreshCaptcha, checkIpBlocked } from "../ReduxStateManagement/slices/authSlice";
...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#171b2e] relative overflow-hidden">
      ...
      <div className="w-full max-w-md flex flex-col items-center z-10 px-4 sm:px-0 py-8 md:relative md:top-[4rem]">
        {/* Logo container */}
        ...
        <form onSubmit={handleSubmit} className="w-full px-2 md:px-12">
          <div className="mb-4 md:mb-5">
            ...
            <div className="relative">
              ...
              <input
                id="username"
                type="text"
                className="w-full text-sm md:text-base pl-10 pr-3 md:pl-10 md:pr-4 py-2 md:py-3 bg-white text-gray-700 rounded-xl md:rounded-2xl focus:outline-none"
                value={username}
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full text-sm md:text-base pl-10 pr-10 md:pl-10 md:pr-12 py-2 md:py-3 bg-white text-gray-700 rounded-xl md:rounded-2xl focus:outline-none"
                value={password}
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-800 p-3 rounded-xl md:rounded-2xl mb-3">
              ...
              <input
                id="captcha"
                type="text"
                className="w-full text-sm md:text-base pl-3 pr-3 py-2 md:py-3 bg-white text-gray-700 rounded-xl md:rounded-2xl focus:outline-none"
                value={captchaInput}
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className="px-10 py-2 rounded-full bg-gradient-to-r from-blue-400 via-blue-600 to-blue-700 text-white font-medium focus:outline-none hover:from-blue-500 hover:to-blue-700 transition-all duration-300 shadow-md"
            >
