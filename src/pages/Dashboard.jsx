              ...
              <div className="relative flex flex-col sm:flex-row justify-between">
                <div>
                  ...
                  <div className="mt-4 flex gap-3 flex-col sm:flex-row">
                    <Link to="/add-funds" className="bg-white text-indigo-600 px-3 py-2 text-sm rounded-lg font-medium hover:bg-opacity-90 transition flex items-center justify-center group w-full sm:w-auto cursor-pointer">
                    ...
                    <Link to="/deduct-funds" className="bg-indigo-900 bg-opacity-40 text-white px-3 py-2 text-sm rounded-lg font-medium hover:bg-opacity-60 transition flex items-center justify-center group border border-white border-opacity-30 w-full sm:w-auto cursor-pointer">
                    ...
                    <Link to="/new-registration" className="text-indigo-600 bg-white dark:bg-indigo-900 bg-opacity-40 dark:text-white px-3 py-2 text-sm rounded-lg font-medium hover:bg-opacity-60 transition flex items-center justify-center group border border-white border-opacity-30 w-full sm:w-auto cursor-pointer">
                ...
                <div className="hidden sm:flex items-center mt-4 sm:mt-0">
                  <Link to="/profile" className="bg-[#191d4e] p-3 rounded-xl text-indigo-600 shadow-lg transform hover:scale-105 transition-transform cursor-pointer">
