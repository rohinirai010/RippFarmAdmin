...
const navItems = [
  ...
  },
  {
    ...
    hasDropdown: true,
    children: [
      { title: "First Deposit Bonus", path: "/admin/deposit-bonus" },
      { title: "Invitation Bonus", path: "/admin/invitation-bonus" },
      { title: "Level Bonus Report", path: "/admin/level-bonus" },
      { title: "Team Winning Bonus", path: "/admin/team-winning-bonus" },
    ],
  },
  {
    id: "bonanza",
