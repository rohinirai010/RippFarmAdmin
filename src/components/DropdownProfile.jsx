...
import { logoutAdmin } from '../ReduxStateManagement/slices/authSlice';
...
function DropdownProfile({ align }) {
  ...
  const { admin } = useSelector((state) => state.auth); // Get admin data from Redux
